...
function valid_check()
{
	...
	if (document.frm1.product_name.value == "")
	{
		alert("상품명을 입력하여 주시기 바랍니다.");
		document.frm1.product_name.focus();
		return false;
	}
...
function delete_check() {
	document.frm1.action = "goodsinfo_delete_ok.jsp?product_name=" + document.frm1.product_name.value;
	document.frm1.submit();
}
</script>
