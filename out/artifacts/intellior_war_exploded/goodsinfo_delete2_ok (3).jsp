...
<%
	...
	String n_content			= multi.getParameter("prodcut_contents");

	try{
	String SQL = "INSERT INTO product(product_name, category, product_price, product_thumnail, product_image, product_contents) VALUES (?, ?, ?, ?, ?, ?)";
