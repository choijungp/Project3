		...
		<tr>
			<td align="center" valign="top">
				<table width="800" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="547" height="45" align="left" class="new_tit">상품 QnA</td>
					</tr>
					<tr>
						<td colspan="2" align="left" valign="top">
							<table width="100%" border="0" cellspacing="1" cellpadding="7" bgcolor="#D7D7D7">
								<tr>
									<td width="10%" align="center" bgcolor="#EEEEEE">상품명</td>
								...
								<%
									...
									String SQL = null;
									SQL = "select review_title, review_grade, user_id FROM review where product_id ='" + product_id + "'";
								...
								{
									String p_name = null;
									p_name = "select product_name from product where product_id ='" + product_id + "'";
									rs3 = stmt.executeQuery(p_name);
								...
								<tr>
									...
									<td align="center" bgcolor="#FFFFFF"><a href="../review_read.jsp?product_id=<%= product_id %>"><%= product_name %></a></td>
									<td align="center" bgcolor="#FFFFFF"><%= review_title		%></td>
									<td align="center" bgcolor="#FFFFFF"><%= review_grade		%></td>
								...
								<tr>
									<td colspan = 7 align="center" bgcolor="#FFFFFF"><a href="./review_insert.jsp">리뷰작성</a></td>
								</tr>
							</table>
				</table>
			</td>
